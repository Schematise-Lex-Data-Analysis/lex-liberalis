...
<main class="flex flex-col h-full bg-slate-100">
  ...
  >
    <h1 class="text-3xl font-mono font-bold inline-flex pr-6 mt-1">LEX-LIBERALIS</h1>
    <SearchBar
      bind:this={searchBar}
      {preferences}
  ...
  <article class="flex flex-1 flex-row relative items-stretch">
    <aside class="w-1/5 border-r-2 flex justify-start items-start flex-col p-5">
      <h1 class="text-xl font-semibold">My Folders</h1>
      <Folder/>
    </aside>
    <SearchResults
